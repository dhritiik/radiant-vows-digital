...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div
          className="max-w-7xl mx-auto rounded-3xl px-3 sm:px-5 md:px-7 py-2 sm:py-2.5 flex items-center justify-between transition-all duration-500"
          style={{
            background: scrolled
              ? "hsl(var(--card) / 0.85)"
              : "hsl(var(--card) / 0.45)",
        ...
        >
          ...
          {/* Desktop nav links */}
          <div className="hidden md:flex items-center gap-1 p-1 rounded-2xl bg-muted/50 border border-border/20">
            {navLinks.map((link) => {
              ...
              return (
                <a
                  ...
                  className="relative px-4 py-1.5 font-sans text-xs font-semibold transition-all duration-300 group"
                  style={{
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <a
              ...
              className="relative overflow-hidden font-sans text-xs sm:text-sm font-bold px-4 sm:px-6 py-2 sm:py-2.5 rounded-full transition-all duration-500 hover:scale-[1.03] hover:shadow-xl group active:scale-95 whitespace-nowrap"
              style={{
            ...
            <button
              ...
              className="md:hidden p-1.5 rounded-lg text-foreground hover:bg-card transition-colors border border-border/20"
                ...
                {navLinks.map((link, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isActive && <Sparkles className="w-3 h-3 text-gold" />}
                    </motion.a>
                  );
                })}
